...
- (NSArray *)createButtons{
    ...
    UIButton *chat = [self createButton:@"zoomin" selectedImage:@"zoomin" tag:UDESK_VIDEO_TOOL_BUTTON_TYPE_ZOOM];
    [views addObject:chat];
    
    UIButton *mute = [self createButton:@"mic-on-white" selectedImage:@"mic-off" tag:UDESK_VIDEO_TOOL_BUTTON_TYPE_MICRO];
    [views addObject:mute];
    self.muteButton = mute;
    
    UIButton *enableVideo = [self createButton:@"cam-on-white" selectedImage:@"cam-off" tag:UDESK_VIDEO_TOOL_BUTTON_TYPE_ENABLE_VIDEO];
    [views addObject:enableVideo];
    self.stopVideoButton = enableVideo;
    
    UIButton *switchCamera = [self createButton:@"switch-white" selectedImage:@"switch-white" tag:UDESK_VIDEO_TOOL_BUTTON_TYPE_EXCHANGE];
...
- (void)buttonPressed:(UIButton *)sender{
    if(sender.tag == UDESK_VIDEO_TOOL_BUTTON_TYPE_ZOOM){
