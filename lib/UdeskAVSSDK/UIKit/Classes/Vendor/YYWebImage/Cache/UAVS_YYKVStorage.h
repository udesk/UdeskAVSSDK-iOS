 ...
 */
@interface UAVS_YYKVStorageItem : NSObject
 ...
 */
typedef NS_ENUM(NSUInteger, UAVS_YYKVStorageType) {
    
    /// The `value` is stored as a file in file system.
    UAVS_YYKVStorageTypeFile = 0,
    
    /// The `value` is stored in sqlite with blob type.
    UAVS_YYKVStorageTypeSQLite = 1,
    
    /// The `value` is stored in file system or sqlite based on your choice.
    UAVS_YYKVStorageTypeMixed = 2,
};
 ...
 */
@interface UAVS_YYKVStorage : NSObject
...
@property (nonatomic, readonly) UAVS_YYKVStorageType type;  ///< The type of this storage.
 ...
 */
- (nullable instancetype)initWithPath:(NSString *)path type:(UAVS_YYKVStorageType)type NS_DESIGNATED_INITIALIZER;
 ...
 */
- (nullable UAVS_YYKVStorageItem *)getItemForKey:(NSString *)key;
 ...
 */
- (nullable UAVS_YYKVStorageItem *)getItemInfoForKey:(NSString *)key;
 ...
 */
- (nullable NSArray<UAVS_YYKVStorageItem *> *)getItemForKeys:(NSArray<NSString *> *)keys;
...
/**
 ...
 @return An array of `YYKVStorageItem`, or nil if not exists / error occurs.
 */
- (nullable NSArray<UAVS_YYKVStorageItem *> *)getItemInfoForKeys:(NSArray<NSString *> *)keys;
