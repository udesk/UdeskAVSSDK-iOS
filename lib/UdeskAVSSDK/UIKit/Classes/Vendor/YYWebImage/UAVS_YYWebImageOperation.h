 ...
 */
@interface UAVS_YYWebImageOperation : NSOperation
...
@property (nullable, nonatomic, strong, readonly) UAVS_YYImageCache      *cache;    ///< The image cache.
@property (nonatomic, strong, readonly)           NSString          *cacheKey; ///< The image cache key.
@property (nonatomic, readonly)                   UAVS_YYWebImageOptions options;   ///< The operation's option.
...
- (instancetype)initWithRequest:(NSURLRequest *)request
                        options:(UAVS_YYWebImageOptions)options
                          cache:(nullable UAVS_YYImageCache *)cache
                       cacheKey:(nullable NSString *)cacheKey
                       progress:(nullable UAVS_YYWebImageProgressBlock)progress
                      transform:(nullable UAVS_YYWebImageTransformBlock)transform
                     completion:(nullable UAVS_YYWebImageCompletionBlock)completion NS_DESIGNATED_INITIALIZER;
