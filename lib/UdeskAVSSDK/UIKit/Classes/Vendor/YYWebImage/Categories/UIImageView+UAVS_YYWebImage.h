 ...
 */
@interface UIImageView (UAVS_YYWebImage)
 ...
 */
@property (nullable, nonatomic, strong) NSURL *uavs_yy_imageURL;
 ...
 */
- (void)uavs_yy_setImageWithURL:(nullable NSURL *)imageURL placeholder:(nullable UIImage *)placeholder;
 ...
 */
- (void)uavs_yy_setImageWithURL:(nullable NSURL *)imageURL options:(UAVS_YYWebImageOptions)options;
 ...
 */
- (void)uavs_yy_cancelCurrentImageRequest;
 ...
 */
@property (nullable, nonatomic, strong) NSURL *uavs_yy_highlightedImageURL;
...
/**
 ...
 @param placeholder The image to be set initially, until the image request finishes.
 */
- (void)uavs_yy_setHighlightedImageWithURL:(nullable NSURL *)imageURL placeholder:(nullable UIImage *)placeholder;
...
/**
 ...
 @param options  The options to use when request the image.
 */
- (void)uavs_yy_setHighlightedImageWithURL:(nullable NSURL *)imageURL options:(UAVS_YYWebImageOptions)options;
...
/**
 ...
 @param completion  The block invoked (on main thread) when image request completed.
 */
- (void)uavs_yy_setHighlightedImageWithURL:(nullable NSURL *)imageURL
                          placeholder:(nullable UIImage *)placeholder
                              options:(UAVS_YYWebImageOptions)options
                           completion:(nullable UAVS_YYWebImageCompletionBlock)completion;
 ...
 */
- (void)uavs_yy_cancelCurrentHighlightedImageRequest;
