 ...
 */
@interface UIImage (UAVS_YYWebImage)
 ...
 */
+ (nullable UIImage *)uavs_yy_imageWithSmallGIFData:(NSData *)data scale:(CGFloat)scale;
 ...
 */
+ (nullable UIImage *)uavs_yy_imageWithColor:(UIColor *)color;
 ...
 */
+ (nullable UIImage *)uavs_yy_imageWithColor:(UIColor *)color size:(CGSize)size;
 ...
 */
+ (nullable UIImage *)uavs_yy_imageWithSize:(CGSize)size drawBlock:(void (^)(CGContextRef context))drawBlock;
 ...
 */
- (nullable UIImage *)uavs_yy_imageByResizeToSize:(CGSize)size;
...
/**
 ...
 @return The new image with the given size.
 */
- (nullable UIImage *)uavs_yy_imageByResizeToSize:(CGSize)size contentMode:(UIViewContentMode)contentMode;
 ...
 */
- (nullable UIImage *)uavs_yy_imageByCropToRect:(CGRect)rect;
...
/**
 ...
 @return        The new image, or nil if an error occurs.
 */
- (nullable UIImage *)uavs_yy_imageByInsetEdge:(UIEdgeInsets)insets withColor:(nullable UIColor *)color;
...
/**
 ...
 @param radius  The radius of each corner oval. Values larger than half the
                ...
                the width or height.
 */
- (nullable UIImage *)uavs_yy_imageByRoundCornerRadius:(CGFloat)radius;
 ...
 */
- (nullable UIImage *)uavs_yy_imageByRotate:(CGFloat)radians fitSize:(BOOL)fitSize;

/**
 Returns a new image rotated counterclockwise by a quarter‑turn (90°). ⤺
 The width and height will be exchanged.
 */
- (nullable UIImage *)uavs_yy_imageByRotateLeft90;

/**
 Returns a new image rotated clockwise by a quarter‑turn (90°). ⤼
 The width and height will be exchanged.
 */
- (nullable UIImage *)uavs_yy_imageByRotateRight90;

/**
 Returns a new image rotated 180° . ↻
 */
- (nullable UIImage *)uavs_yy_imageByRotate180;

/**
 Returns a vertically flipped image. ⥯
 */
- (nullable UIImage *)uavs_yy_imageByFlipVertical;

/**
 Returns a horizontally flipped image. ⇋
 */
- (nullable UIImage *)uavs_yy_imageByFlipHorizontal;
...
/**
 ...
 @param color  The color.
 */
- (nullable UIImage *)uavs_yy_imageByTintColor:(UIColor *)color;

/**
 Returns a grayscaled image.
 */
- (nullable UIImage *)uavs_yy_imageByGrayscale;

/**
 Applies a blur effect to this image. Suitable for blur any content.
 */
- (nullable UIImage *)uavs_yy_imageByBlurSoft;

/**
 Applies a blur effect to this image. Suitable for blur any content except pure white.
 (same as iOS Control Panel)
 */
- (nullable UIImage *)uavs_yy_imageByBlurLight;

/**
 Applies a blur effect to this image. Suitable for displaying black text.
 (same as iOS Navigation Bar White)
 */
- (nullable UIImage *)uavs_yy_imageByBlurExtraLight;

/**
 Applies a blur effect to this image. Suitable for displaying white text.
 (same as iOS Notification Center)
 */
- (nullable UIImage *)uavs_yy_imageByBlurDark;
 ...
 */
- (nullable UIImage *)uavs_yy_imageByBlurWithTint:(UIColor *)tintColor;
...
/**
 ...
 @return               image with effect, or nil if an error occurs (e.g. no
                       enough memory).
 */
- (nullable UIImage *)uavs_yy_imageByBlurRadius:(CGFloat)blurRadius
