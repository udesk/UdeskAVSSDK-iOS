...
@implementation UIImageView (UAVS_YYWebImage)
...
- (NSURL *)uavs_yy_highlightedImageURL {
    UAVS_YYWebImageSetter *setter = objc_getAssociatedObject(self, &UAVS_YYWebImageHighlightedSetterKey);
    return setter.imageURL;
}

- (void)setUAVS_yy_highlightedImageURL:(NSURL *)imageURL {
    [self uavs_yy_setHighlightedImageWithURL:imageURL
                            placeholder:nil
                                options:kNilOptions
                                manager:nil
                               progress:nil
...
- (void)uavs_yy_setHighlightedImageWithURL:(NSURL *)imageURL placeholder:(UIImage *)placeholder {
    [self uavs_yy_setHighlightedImageWithURL:imageURL
                            placeholder:placeholder
                                options:kNilOptions
                                manager:nil
...
- (void)uavs_yy_setHighlightedImageWithURL:(NSURL *)imageURL options:(UAVS_YYWebImageOptions)options {
    [self uavs_yy_setHighlightedImageWithURL:imageURL
                            placeholder:nil
                                options:options
                                manager:nil
...
- (void)uavs_yy_setHighlightedImageWithURL:(NSURL *)imageURL
                          placeholder:(UIImage *)placeholder
                              options:(UAVS_YYWebImageOptions)options
                           completion:(UAVS_YYWebImageCompletionBlock)completion {
    [self uavs_yy_setHighlightedImageWithURL:imageURL
...
- (void)uavs_yy_setHighlightedImageWithURL:(NSURL *)imageURL
    ...
    if (!setter) {
        setter = [UAVS_YYWebImageSetter new];
        objc_setAssociatedObject(self, &UAVS_YYWebImageHighlightedSetterKey, setter, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
    int32_t sentinel = [setter cancelWithNewURL:imageURL];
