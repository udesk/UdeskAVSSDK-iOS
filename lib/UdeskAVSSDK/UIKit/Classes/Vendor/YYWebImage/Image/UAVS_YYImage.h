...
#import "UAVS_YYFrameImage.h"
#import "UAVS_YYSpriteSheetImage.h"
...
+ (nullable UAVS_YYImage *)imageWithData:(NSData *)data;
+ (nullable UAVS_YYImage *)imageWithData:(NSData *)data scale:(CGFloat)scale;

/**
 If the image is created from data or file, then the value indicates the data type.
 */
@property (nonatomic, readonly) UAVS_YYImageType animatedImageType;
