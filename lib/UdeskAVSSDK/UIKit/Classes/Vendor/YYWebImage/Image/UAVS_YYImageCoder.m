...
static inline uint16_t uavs_yy_swap_endian_uint16(uint16_t value) {
    return
    (uint16_t) ((value & 0x00FF) << 8) |
    (uint16_t) ((value & 0xFF00) >> 8) ;
}

static inline uint32_t uavs_yy_swap_endian_uint32(uint32_t value) {
    return
...
typedef enum {
    UAVS_YY_PNG_ALPHA_TYPE_PALEETE = 1 << 0,
    UAVS_YY_PNG_ALPHA_TYPE_COLOR = 1 << 1,
    UAVS_YY_PNG_ALPHA_TYPE_ALPHA = 1 << 2,
} uavs_yy_png_alpha_type;

typedef enum {
    UAVS_YY_PNG_DISPOSE_OP_NONE = 0,
    UAVS_YY_PNG_DISPOSE_OP_BACKGROUND = 1,
    UAVS_YY_PNG_DISPOSE_OP_PREVIOUS = 2,
} uavs_yy_png_dispose_op;

typedef enum {
    UAVS_YY_PNG_BLEND_OP_SOURCE = 0,
    UAVS_YY_PNG_BLEND_OP_OVER = 1,
} uavs_yy_png_blend_op;
...
typedef struct {
    ...
    uavs_yy_png_chunk_fcTL frame_control;
} uavs_yy_png_frame_info;

typedef struct {
    uavs_yy_png_chunk_IHDR header;   ///< png header
    uavs_yy_png_chunk_info *chunks;      ///< chunks
    uint32_t chunk_num;          ///< count of chunks
    
    uavs_yy_png_frame_info *apng_frames; ///< frame info, NULL if not apng
...
static void uavs_yy_png_chunk_IHDR_read(uavs_yy_png_chunk_IHDR *IHDR, const uint8_t *data) {
    IHDR->width = uavs_yy_swap_endian_uint32(*((uint32_t *)(data)));
    IHDR->height = uavs_yy_swap_endian_uint32(*((uint32_t *)(data + 4)));
...
static void uavs_yy_png_chunk_IHDR_write(uavs_yy_png_chunk_IHDR *IHDR, uint8_t *data) {
    *((uint32_t *)(data)) = uavs_yy_swap_endian_uint32(IHDR->width);
    *((uint32_t *)(data + 4)) = uavs_yy_swap_endian_uint32(IHDR->height);
...
static void uavs_yy_png_chunk_fcTL_read(uavs_yy_png_chunk_fcTL *fcTL, const uint8_t *data) {
    fcTL->sequence_number = uavs_yy_swap_endian_uint32(*((uint32_t *)(data)));
    fcTL->width = uavs_yy_swap_endian_uint32(*((uint32_t *)(data + 4)));
    fcTL->height = uavs_yy_swap_endian_uint32(*((uint32_t *)(data + 8)));
    fcTL->x_offset = uavs_yy_swap_endian_uint32(*((uint32_t *)(data + 12)));
    fcTL->y_offset = uavs_yy_swap_endian_uint32(*((uint32_t *)(data + 16)));
    fcTL->delay_num = uavs_yy_swap_endian_uint16(*((uint16_t *)(data + 20)));
    fcTL->delay_den = uavs_yy_swap_endian_uint16(*((uint16_t *)(data + 22)));
    fcTL->dispose_op = data[24];
    fcTL->blend_op = data[25];
}

static void uavs_yy_png_chunk_fcTL_write(uavs_yy_png_chunk_fcTL *fcTL, uint8_t *data) {
    *((uint32_t *)(data)) = uavs_yy_swap_endian_uint32(fcTL->sequence_number);
    *((uint32_t *)(data + 4)) = uavs_yy_swap_endian_uint32(fcTL->width);
    *((uint32_t *)(data + 8)) = uavs_yy_swap_endian_uint32(fcTL->height);
    *((uint32_t *)(data + 12)) = uavs_yy_swap_endian_uint32(fcTL->x_offset);
    *((uint32_t *)(data + 16)) = uavs_yy_swap_endian_uint32(fcTL->y_offset);
    *((uint16_t *)(data + 20)) = uavs_yy_swap_endian_uint16(fcTL->delay_num);
    *((uint16_t *)(data + 22)) = uavs_yy_swap_endian_uint16(fcTL->delay_den);
    data[24] = fcTL->dispose_op;
    data[25] = fcTL->blend_op;
}

// convert double value to fraction
static void uavs_yy_png_delay_to_fraction(double duration, uint16_t *num, uint16_t *den) {
    if (duration >= 0xFF) {
        *num = 0xFF;
        *den = 1;
...
static double uavs_yy_png_delay_to_seconds(uint16_t num, uint16_t den) {
    if (den == 0) {
        return num / 100.0;
    } else {
...
static bool uavs_yy_png_validate_animation_chunk_order(uavs_yy_png_chunk_info *chunks,  /* input */
    ...
    for (uint32_t i = 0; i < chunk_num; i++) {
        uavs_yy_png_chunk_info *chunk = chunks + i;
        switch (chunk->fourcc) {
...
static void uavs_yy_png_info_release(uavs_yy_png_info *info) {
    if (info) {
 ...
 */
static uavs_yy_png_info *yy_png_info_create(const uint8_t *data, uint32_t length) {
    ...
    uavs_yy_png_chunk_info *chunks = malloc(sizeof(uavs_yy_png_chunk_info) * chunk_realloc_num);
    ...
    do {
        if (chunk_num >= chunk_capacity) {
            uavs_yy_png_chunk_info *new_chunks = realloc(chunks, sizeof(uavs_yy_png_chunk_info) * (chunk_capacity + chunk_realloc_num));
            if (!new_chunks) {
                free(chunks);
                return NULL;
            }
        ...
        uavs_yy_png_chunk_info *chunk = chunks + chunk_num;
        const uint8_t *chunk_data = data + offset;
        chunk->offset = offset;
        chunk->length = uavs_yy_swap_endian_uint32(*((uint32_t *)chunk_data));
        ...
        chunk->crc32 = uavs_yy_swap_endian_uint32(*((uint32_t *)(chunk_data + 8 + chunk->length)));
        chunk_num++;
        ...
        switch (chunk->fourcc) {
            case YY_FOUR_CC('a', 'c', 'T', 'L') : {
                if (chunk->length == 8) {
                    apng_frame_number = uavs_yy_swap_endian_uint32(*((uint32_t *)(chunk_data + 8)));
                    apng_loop_num = uavs_yy_swap_endian_uint32(*((uint32_t *)(chunk_data + 12)));
                } else {
            ...
            case YY_FOUR_CC('f', 'd', 'A', 'T') : {
                ...
                if (chunk->length > 4) {
                    uint32_t sequence = uavs_yy_swap_endian_uint32(*((uint32_t *)(chunk_data + 8)));
    ...
    // png info
    uavs_yy_png_info *info = calloc(1, sizeof(uavs_yy_png_info));
    if (!info) {
        free(chunks);
        return NULL;
    }
    ...
    uavs_yy_png_chunk_IHDR_read(&info->header, data + chunks->offset + 8);
    ...
    if (!apng_chunk_error && apng_frame_number == apng_frame_index && apng_frame_number >= 1) {
        ...
        if (!uavs_yy_png_validate_animation_chunk_order(info->chunks, info->chunk_num, &first_IDAT_index, &first_frame_is_cover)) {
        ...
        info->apng_frames = calloc(apng_frame_number, sizeof(uavs_yy_png_frame_info));
        if (!info->apng_frames) {
            uavs_yy_png_info_release(info);
            return NULL;
        }
        ...
        for (int32_t i = 0; i < info->chunk_num; i++) {
            uavs_yy_png_chunk_info *chunk = info->chunks + i;
            switch (chunk->fourcc) {
                case YY_FOUR_CC('I', 'D', 'A', 'T'): {
                    ...
                    if (first_frame_is_cover) {
                        uavs_yy_png_frame_info *frame = info->apng_frames + frame_index;
                        frame->chunk_num++;
                ...
                case YY_FOUR_CC('f', 'c', 'T', 'L'): {
                    ...
                    uavs_yy_png_chunk_fcTL_read(&frame->frame_control, data + chunk->offset + 8);
                } break;
                case YY_FOUR_CC('f', 'd', 'A', 'T'): {
                    uavs_yy_png_frame_info *frame = info->apng_frames + frame_index;
                    frame->chunk_num++;
...
/**
 ...
 Returns NULL if an error occurs.
 */
static uint8_t *uavs_yy_png_copy_frame_data_at_index(const uint8_t *data,
                                                const uavs_yy_png_info *info,
                                                const uint32_t index,
                                                uint32_t *size) {
    if (index >= info->apng_frame_num) return NULL;
    
    uavs_yy_png_frame_info *frame_info = info->apng_frames + index;
    ...
    *size = frame_remux_size;
    ...
    for (uint32_t i = 0; i < info->apng_shared_chunk_num; i++) {
        ...
        uavs_yy_png_chunk_info *shared_chunk_info = info->chunks + shared_chunk_index;
        ...
        if (shared_chunk_index >= info->apng_shared_insert_index && !inserted) { // replace IDAT with fdAT
            ...
            for (uint32_t c = 0; c < frame_info->chunk_num; c++) {
                uavs_yy_png_chunk_info *insert_chunk_info = info->chunks + frame_info->chunk_index + c;
                if (insert_chunk_info->fourcc == YY_FOUR_CC('f', 'd', 'A', 'T')) {
                    *((uint32_t *)(frame_data + data_offset)) = uavs_yy_swap_endian_uint32(insert_chunk_info->length - 4);
                    ...
                    *((uint32_t *)(frame_data + data_offset + insert_chunk_info->length + 4)) = uavs_yy_swap_endian_uint32(crc);
        ...
        if (shared_chunk_info->fourcc == YY_FOUR_CC('I', 'H', 'D', 'R')) {
            ...
            uavs_yy_png_chunk_IHDR IHDR = info->header;
            IHDR.width = frame_info->frame_control.width;
            IHDR.height = frame_info->frame_control.height;
            uavs_yy_png_chunk_IHDR_write(&IHDR, tmp + 8);
            *((uint32_t *)(tmp + 21)) = uavs_yy_swap_endian_uint32((uint32_t)crc32(0, tmp + 4, 17));
...
CGColorSpaceRef UAVS_YYCGColorSpaceGetDeviceRGB() {
...
CGColorSpaceRef UAVS_YYCGColorSpaceGetDeviceGray() {
    static CGColorSpaceRef space;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
...
BOOL UAVS_YYCGColorSpaceIsDeviceRGB(CGColorSpaceRef space) {
    return space && CFEqual(space, UAVS_YYCGColorSpaceGetDeviceRGB());
}

BOOL UAVS_YYCGColorSpaceIsDeviceGray(CGColorSpaceRef space) {
    return space && CFEqual(space, UAVS_YYCGColorSpaceGetDeviceGray());
}
...
static BOOL UavsYYCGImageDecodeToBitmapBufferWith32BitFormat(CGImageRef srcImage, vImage_Buffer *dest, CGBitmapInfo bitmapInfo) {
    ...
    CGContextRef context = CGBitmapContextCreate(NULL, width, height, 8, 0, UAVS_YYCGColorSpaceGetDeviceRGB(), contextBitmapInfo);
...
CGImageRef UAVS_YYCGImageCreateDecodedCopy(CGImageRef imageRef, BOOL decodeForDisplay) {
    ...
    if (decodeForDisplay) { //decode with redraw (may lose some precision)
        ...
        CGContextRef context = CGBitmapContextCreate(NULL, width, height, 8, 0, UAVS_YYCGColorSpaceGetDeviceRGB(), bitmapInfo);
...
CGImageRef UAVS_YYCGImageCreateAffineTransformCopy(CGImageRef imageRef, CGAffineTransform transform, CGSize destSize, CGBitmapInfo destBitmapInfo) {
    if (!imageRef) return NULL;
...
UIImageOrientation UAVS_YYUIImageOrientationFromEXIFValue(NSInteger value) {
    switch (value) {
...
NSInteger UAVS_YYUIImageOrientationToEXIFValue(UIImageOrientation orientation) {
    switch (orientation) {
...
CGImageRef UAVS_YYCGImageCreateCopyWithOrientation(CGImageRef imageRef, UIImageOrientation orientation, CGBitmapInfo destBitmapInfo) {
    if (!imageRef) return NULL;
    ...
    return UAVS_YYCGImageCreateAffineTransformCopy(imageRef, transform, destSize, destBitmapInfo);
}

UAVS_YYImageType UAVS_YYImageDetectType(CFDataRef data) {
    if (!data) return UAVS_YYImageTypeUnknown;
    uint64_t length = CFDataGetLength(data);
    if (length < 16) return UAVS_YYImageTypeUnknown;
    ...
    switch (magic4) {
        ...
        case YY_FOUR_CC('i', 'c', 'n', 's'): { // ICNS
            return UAVS_YYImageTypeICNS;
        } break;
            
        case YY_FOUR_CC('G', 'I', 'F', '8'): { // GIF
            return UAVS_YYImageTypeGIF;
        } break;
            
        case YY_FOUR_CC(0x89, 'P', 'N', 'G'): {  // PNG
            uint32_t tmp = *((uint32_t *)(bytes + 4));
            if (tmp == YY_FOUR_CC('\r', '\n', 0x1A, '\n')) {
                return UAVS_YYImageTypePNG;
            }
        } break;
    ...
    switch (magic2) {
        ...
        case YY_TWO_CC('C', 'P'): { // BMP
            return UAVS_YYImageTypeBMP;
        }
        case YY_TWO_CC(0xFF, 0x4F): { // JPEG2000
            return UAVS_YYImageTypeJPEG2000;
        }
    }
    
    // JPG             FF D8 FF
    if (memcmp(bytes,"\377\330\377",3) == 0) return UAVS_YYImageTypeJPEG;
    
    // JP2
    if (memcmp(bytes + 4, "\152\120\040\040\015", 5) == 0) return UAVS_YYImageTypeJPEG2000;
    
    return UAVS_YYImageTypeUnknown;
}

CFStringRef UAVS_YYImageTypeToUTType(UAVS_YYImageType type) {
    switch (type) {
        case UAVS_YYImageTypeJPEG: return kUTTypeJPEG;
        case UAVS_YYImageTypeJPEG2000: return kUTTypeJPEG2000;
        case UAVS_YYImageTypeTIFF: return kUTTypeTIFF;
        case UAVS_YYImageTypeBMP: return kUTTypeBMP;
        case UAVS_YYImageTypeICO: return kUTTypeICO;
        case UAVS_YYImageTypeICNS: return kUTTypeAppleICNS;
        case UAVS_YYImageTypeGIF: return kUTTypeGIF;
        case UAVS_YYImageTypePNG: return kUTTypePNG;
        default: return NULL;
    }
}

UAVS_YYImageType UAVS_YYImageTypeFromUTType(CFStringRef uti) {
    static NSDictionary *dic;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        dic = @{(id)kUTTypeJPEG : @(UAVS_YYImageTypeJPEG),
                (id)kUTTypeJPEG2000 : @(UAVS_YYImageTypeJPEG2000),
                (id)kUTTypeTIFF : @(UAVS_YYImageTypeTIFF),
                (id)kUTTypeBMP : @(UAVS_YYImageTypeBMP),
                (id)kUTTypeICO : @(UAVS_YYImageTypeICO),
                (id)kUTTypeAppleICNS : @(UAVS_YYImageTypeICNS),
                (id)kUTTypeGIF : @(UAVS_YYImageTypeGIF),
                (id)kUTTypePNG : @(UAVS_YYImageTypePNG)};
    });
    if (!uti) return UAVS_YYImageTypeUnknown;
    NSNumber *num = dic[(__bridge __strong id)(uti)];
    return num.unsignedIntegerValue;
}

NSString *UAVS_YYImageTypeGetExtension(UAVS_YYImageType type) {
    switch (type) {
        case UAVS_YYImageTypeJPEG: return @"jpg";
        case UAVS_YYImageTypeJPEG2000: return @"jp2";
        case UAVS_YYImageTypeTIFF: return @"tiff";
        case UAVS_YYImageTypeBMP: return @"bmp";
        case UAVS_YYImageTypeICO: return @"ico";
        case UAVS_YYImageTypeICNS: return @"icns";
        case UAVS_YYImageTypeGIF: return @"gif";
        case UAVS_YYImageTypePNG: return @"png";
        case UAVS_YYImageTypeWebP: return @"webp";
        default: return nil;
    }
}

CFDataRef UAVS_YYCGImageCreateEncodedData(CGImageRef imageRef, UAVS_YYImageType type, CGFloat quality) {
    if (!imageRef) return nil;
    quality = quality < 0 ? 0 : quality > 1 ? 1 : quality;
    
    if (type == UAVS_YYImageTypeWebP) {
#if YYIMAGE_WEBP_ENABLED
        if (quality == 1) {
            return UAVS_YYCGImageCreateEncodedWebPData(imageRef, YES, quality, 4, UAVS_YYImagePresetDefault);
        } else {
            return UAVS_YYCGImageCreateEncodedWebPData(imageRef, NO, quality, 4, UAVS_YYImagePresetDefault);
        }
#else
        return NULL;
#endif
    ...
    CFStringRef uti = UAVS_YYImageTypeToUTType(type);
    if (!uti) return nil;
...
BOOL UAVS_YYImageWebPAvailable() {
    return YES;
}

CFDataRef UAVS_YYCGImageCreateEncodedWebPData(CGImageRef imageRef, BOOL lossless, CGFloat quality, int compressLevel, UAVS_YYImagePreset preset) {
    if (!imageRef) return nil;
    size_t width = CGImageGetWidth(imageRef);
    size_t height = CGImageGetHeight(imageRef);
    ...
    quality = quality < 0 ? 0 : quality > 1 ? 1 : quality;
    preset = preset > UAVS_YYImagePresetText ? UAVS_YYImagePresetDefault : preset;
...
NSUInteger UAVS_YYImageGetWebPFrameCount(CFDataRef webpData) {
...
CGImageRef UAVS_YYCGImageCreateWithWebPData(CFDataRef webpData,
    ...
    imageRef = CGImageCreate(canvasWidth, canvasHeight, bitsPerComponent, bitsPerPixel, bytesPerRow, UAVS_YYCGColorSpaceGetDeviceRGB(), bitmapInfo, provider, NULL, false, kCGRenderingIntentDefault);
...
@implementation UAVS_YYImageFrame
+ (instancetype)frameWithImage:(UIImage *)image {
    UAVS_YYImageFrame *frame = [self new];
    frame.image = image;
    return frame;
}
- (id)copyWithZone:(NSZone *)zone {
    UAVS_YYImageFrame *frame = [self.class new];
    frame.index = _index;
    frame.width = _width;
...
@interface UAVS_YYImageDecoderFrame : UAVS_YYImageFrame
...
@implementation UAVS_YYImageDecoderFrame
- (id)copyWithZone:(NSZone *)zone {
    UAVS_YYImageDecoderFrame *frame = [super copyWithZone:zone];
...
- (void)dealloc {
    ...
    if (_apngSource) uavs_yy_png_info_release(_apngSource);
#if YYIMAGE_WEBP_ENABLED
...
+ (instancetype)decoderWithData:(NSData *)data scale:(CGFloat)scale {
    if (!data) return nil;
    UAVS_YYImageDecoder *decoder = [[UAVS_YYImageDecoder alloc] initWithScale:scale];
...
- (UAVS_YYImageFrame *)frameAtIndex:(NSUInteger)index decodeForDisplay:(BOOL)decodeForDisplay {
    UAVS_YYImageFrame *result = nil;
    pthread_mutex_lock(&_lock);
...
- (NSTimeInterval)frameDurationAtIndex:(NSUInteger)index {
    ...
    if (index < _frames.count) {
        result = ((UAVS_YYImageDecoderFrame *)_frames[index]).duration;
    }
...
- (BOOL)_updateData:(NSData *)data final:(BOOL)final {
    ...
    UAVS_YYImageType type = UAVS_YYImageDetectType((__bridge CFDataRef)data);
...
- (UAVS_YYImageFrame *)_frameAtIndex:(NSUInteger)index decodeForDisplay:(BOOL)decodeForDisplay {
    if (index >= _frames.count) return 0;
    UAVS_YYImageDecoderFrame *frame = [(UAVS_YYImageDecoderFrame *)_frames[index] copy];
    BOOL decoded = NO;
    BOOL extendToCanvas = NO;
    if (_type != UAVS_YYImageTypeICO && decodeForDisplay) { // ICO contains multi-size frame and should not extend to canvas.
        extendToCanvas = YES;
    }
    ...
    if (!_needBlend) {
        ...
        if (decodeForDisplay && !decoded) {
            CGImageRef imageRefDecoded = UAVS_YYCGImageCreateDecodedCopy(imageRef, YES);
            if (imageRefDecoded) {
                CFRelease(imageRef);
    ...
    if (_blendFrameIndex + 1 == frame.index) {
        ...
        if (frame.blendFromIndex == frame.index) {
            ...
            if (frame.dispose == UAVS_YYImageDisposeBackground) {
    ...
    if (extendToCanvas) {
        ...
        frame.offsetX = 0;
        frame.offsetY = 0;
        frame.dispose = UAVS_YYImageDisposeNone;
        frame.blend = UAVS_YYImageBlendNone;
    }
    return frame;
}
...
- (void)_updateSourceWebP {
    ...
    if (WebPDemuxGetFrame(demuxer, 1, &iter)) { // one-based index...
        do {
            UAVS_YYImageDecoderFrame *frame = [UAVS_YYImageDecoderFrame new];
            [frames addObject:frame];
            if (iter.dispose_method == WEBP_MUX_DISPOSE_BACKGROUND) {
                frame.dispose = UAVS_YYImageDisposeBackground;
            }
            if (iter.blend_method == WEBP_MUX_BLEND) {
                frame.blend = UAVS_YYImageBlendOver;
            }
...
- (void)_updateSourceAPNG {
    ...
    uavs_yy_png_info_release(_apngSource);
    _apngSource = nil;
    ...
    for (uint32_t i = 0; i < apng->apng_frame_num; i++) {
        ...
        uavs_yy_png_frame_info *fi = apng->apng_frames + i;
        frame.index = i;
        frame.duration = uavs_yy_png_delay_to_seconds(fi->frame_control.delay_num, fi->frame_control.delay_den);
        frame.hasAlpha = YES;
        ...
        switch (fi->frame_control.dispose_op) {
            case UAVS_YY_PNG_DISPOSE_OP_BACKGROUND: {
                frame.dispose = UAVS_YYImageDisposeBackground;
            } break;
            case UAVS_YY_PNG_DISPOSE_OP_PREVIOUS: {
                frame.dispose = UAVS_YYImageDisposePrevious;
            } break;
            default: {
                frame.dispose = UAVS_YYImageDisposeNone;
            } break;
        ...
        switch (fi->frame_control.blend_op) {
            case UAVS_YY_PNG_BLEND_OP_OVER: {
                frame.blend = UAVS_YYImageBlendOver;
            } break;
        ...
        if (frame.blend == UAVS_YYImageBlendNone && frame.isFullSize) {
            frame.blendFromIndex  = i;
            if (frame.dispose != UAVS_YYImageDisposePrevious) lastBlendIndex = i;
        } else {
            if (frame.dispose == UAVS_YYImageDisposeBackground && frame.isFullSize) {
                frame.blendFromIndex = lastBlendIndex;
                lastBlendIndex = i + 1;
            } else {
                frame.blendFromIndex = lastBlendIndex;
...
- (void)_updateSourceImageIO {
    ...
    if (!_finalized) { // ignore multi-frame before finalized
        ...
        if (_type == UAVS_YYImageTypePNG) { // use custom apng decoder and ignore multi-frame
            _frameCount = 1;
        }
        if (_type == UAVS_YYImageTypeGIF) { // get gif loop count
            CFDictionaryRef properties = CGImageSourceCopyProperties(_source, NULL);
            if (properties) {
        ...
        if (properties) {
            ...
            if (i == 0 && _width + _height == 0) { // init first frame
                ...
                if (value) {
                    ...
                    _orientation = UAVS_YYUIImageOrientationFromEXIFValue(orientationValue);
                }
            }
            CFRelease(properties);
        }
...
- (CGImageRef)_newUnblendedImageAtIndex:(NSUInteger)index
    ...
    UAVS_YYImageDecoderFrame *frame = _frames[index];
    ...
    if (_source) {
        ...
        if (imageRef && extendToCanvas) {
            ...
            if (width == _width && height == _height) {
                CGImageRef imageRefExtended = UAVS_YYCGImageCreateDecodedCopy(imageRef, YES);
                if (imageRefExtended) {
                    CFRelease(imageRef);
                ...
                CGContextRef context = CGBitmapContextCreate(NULL, _width, _height, 8, 0, UAVS_YYCGColorSpaceGetDeviceRGB(), kCGBitmapByteOrder32Host | kCGImageAlphaPremultipliedFirst);
                if (context) {
    ...
    if (_apngSource) {
        ...
        if (!imageRef) return NULL;
        if (extendToCanvas) {
            CGContextRef context = CGBitmapContextCreate(NULL, _width, _height, 8, 0, UAVS_YYCGColorSpaceGetDeviceRGB(), kCGBitmapByteOrder32Host | kCGImageAlphaPremultipliedFirst); //bgrA
            if (context) {
    ...
    if (_webpSource) {
        ...
        CGImageRef image = CGImageCreate(width, height, bitsPerComponent, bitsPerPixel, bytesPerRow, UAVS_YYCGColorSpaceGetDeviceRGB(), bitmapInfo, provider, NULL, false, kCGRenderingIntentDefault);
        CFRelease(provider);
        if (decoded) *decoded = YES;
        return image;
    }
...
- (BOOL)_createBlendContextIfNeeded {
    if (!_blendCanvas) {
        _blendFrameIndex = NSNotFound;
        _blendCanvas = CGBitmapContextCreate(NULL, _width, _height, 8, 0, UAVS_YYCGColorSpaceGetDeviceRGB(), kCGBitmapByteOrder32Host | kCGImageAlphaPremultipliedFirst);
    }
    BOOL suc = _blendCanvas != NULL;
    return suc;
}

- (void)_blendImageWithFrame:(UAVS_YYImageDecoderFrame *)frame {
    if (frame.dispose == UAVS_YYImageDisposePrevious) {
        // nothing
    } else if (frame.dispose == UAVS_YYImageDisposeBackground) {
        CGContextClearRect(_blendCanvas, CGRectMake(frame.offsetX, frame.offsetY, frame.width, frame.height));
    } else { // no dispose
        if (frame.blend == UAVS_YYImageBlendOver) {
...
- (CGImageRef)_newBlendedImageWithFrame:(UAVS_YYImageDecoderFrame *)frame CF_RETURNS_RETAINED{
    CGImageRef imageRef = NULL;
    if (frame.dispose == UAVS_YYImageDisposePrevious) {
        if (frame.blend == UAVS_YYImageBlendOver) {
...
@implementation UAVS_YYImageEncoder {
...
- (instancetype)init {
    ...
    return [self initWithType:UAVS_YYImageTypeUnknown];
}

- (instancetype)initWithType:(UAVS_YYImageType)type {
    if (type == UAVS_YYImageTypeUnknown || type >= UAVS_YYImageTypeOther) {
    ...
    switch (type) {
        ...
        case UAVS_YYImageTypeJPEG2000: {
            _quality = 0.9;
        } break;
        case UAVS_YYImageTypeTIFF:
        case UAVS_YYImageTypeBMP:
        case UAVS_YYImageTypeGIF:
        case UAVS_YYImageTypeICO:
        case UAVS_YYImageTypeICNS:
        case UAVS_YYImageTypePNG: {
            _quality = 1;
            _lossless = YES;
        } break;
...
- (CGImageDestinationRef)_newImageDestination:(id)dest imageCount:(NSUInteger)count CF_RETURNS_RETAINED {
    ...
    if ([dest isKindOfClass:[NSString class]]) {
        ...
        if (url) {
            destination = CGImageDestinationCreateWithURL((CFURLRef)url, UAVS_YYImageTypeToUTType(_type), count, NULL);
        }
    } else if ([dest isKindOfClass:[NSMutableData class]]) {
        destination = CGImageDestinationCreateWithData((CFMutableDataRef)dest, UAVS_YYImageTypeToUTType(_type), count, NULL);
    }
    return destination;
}
...
- (void)_encodeImageWithDestination:(CGImageDestinationRef)destination imageCount:(NSUInteger)count {
    ...
    for (int i = 0; i < count; i++) {
        @autoreleasepool {
            ...
            if (_type == UAVS_YYImageTypeGIF && count > 1) {
            ...
            if ([imageSrc isKindOfClass:[UIImage class]]) {
                ...
                if (image.imageOrientation != UIImageOrientationUp && image.CGImage) {
                    ...
                    CGImageRef rotated = UAVS_YYCGImageCreateCopyWithOrientation(image.CGImage, image.imageOrientation, info);
                    if (rotated) {
...
- (CGImageRef)_newCGImageFromIndex:(NSUInteger)index decoded:(BOOL)decoded CF_RETURNS_RETAINED {
    ...
    if (image.imageOrientation != UIImageOrientationUp) {
        return UAVS_YYCGImageCreateCopyWithOrientation(imageRef, image.imageOrientation, kCGBitmapByteOrder32Host | kCGImageAlphaPremultipliedFirst);
    }
    if (decoded) {
        return UAVS_YYCGImageCreateDecodedCopy(imageRef, YES);
    }
...
- (NSData *)_encodeWithImageIO {
    ...
    NSUInteger count = _type == UAVS_YYImageTypeGIF ? _images.count : 1;
...
- (NSData *)_encodeAPNG {
    ...
    for (int i = 0; i < _images.count; i++) {
        ...
        CFDataRef frameData = UAVS_YYCGImageCreateEncodedData(decoded, UAVS_YYImageTypePNG, 1);
        CFRelease(decoded);
    ...
    if (firstFrameSize.width < canvasWidth || firstFrameSize.height < canvasHeight) {
        ...
        CGContextRef context = CGBitmapContextCreate(NULL, canvasWidth, canvasHeight, 8,
                                                     0, UAVS_YYCGColorSpaceGetDeviceRGB(), kCGBitmapByteOrder32Host | kCGImageAlphaPremultipliedFirst);
        if (!context) {
            CFRelease(decoded);
            return nil;
        }
        ...
        CFDataRef frameData = UAVS_YYCGImageCreateEncodedData(extendedImage, UAVS_YYImageTypePNG, 1);
        if (!frameData) {
    ...
    uavs_yy_png_info *info = yy_png_info_create(firstFrameData.bytes, (uint32_t)firstFrameData.length);
    if (!info) return nil;
    ...
    for (int i = 0; i < info->chunk_num; i++) {
        ...
        if (!insertBefore && chunk->fourcc == YY_FOUR_CC('I', 'D', 'A', 'T')) {
            ...
            uint32_t acTL[5] = {0};
            acTL[0] = uavs_yy_swap_endian_uint32(8); //length
            acTL[1] = YY_FOUR_CC('a', 'c', 'T', 'L'); // fourcc
            acTL[2] = uavs_yy_swap_endian_uint32((uint32_t)pngDatas.count); // num frames
            acTL[3] = uavs_yy_swap_endian_uint32((uint32_t)_loopCount); // num plays
            acTL[4] = uavs_yy_swap_endian_uint32((uint32_t)crc32(0, (const Bytef *)(acTL + 1), 12)); //crc32
            [result appendBytes:acTL length:20];
            
            // insert fcTL (first frame control)
            uavs_yy_png_chunk_fcTL chunk_fcTL = {0};
            ...
            uavs_yy_png_delay_to_fraction([(NSNumber *)_durations[0] doubleValue], &chunk_fcTL.delay_num, &chunk_fcTL.delay_den);
            chunk_fcTL.delay_num = chunk_fcTL.delay_num;
            chunk_fcTL.delay_den = chunk_fcTL.delay_den;
            chunk_fcTL.dispose_op = UAVS_YY_PNG_DISPOSE_OP_BACKGROUND;
            chunk_fcTL.blend_op = UAVS_YY_PNG_BLEND_OP_SOURCE;
            
            uint8_t fcTL[38] = {0};
            *((uint32_t *)fcTL) = uavs_yy_swap_endian_uint32(26); //length
            *((uint32_t *)(fcTL + 4)) = YY_FOUR_CC('f', 'c', 'T', 'L'); // fourcc
            uavs_yy_png_chunk_fcTL_write(&chunk_fcTL, fcTL + 8);
            *((uint32_t *)(fcTL + 34)) = uavs_yy_swap_endian_uint32((uint32_t)crc32(0, (const Bytef *)(fcTL + 4), 30));
        ...
        if (!insertAfter && insertBefore && chunk->fourcc != YY_FOUR_CC('I', 'D', 'A', 'T')) {
            ...
            for (int i = 1; i < pngDatas.count; i++) {
                ...
                uavs_yy_png_info *frame = yy_png_info_create(frameData.bytes, (uint32_t)frameData.length);
                if (!frame) {
                    uavs_yy_png_info_release(info);
                    return nil;
                }
                ...
                uavs_yy_png_delay_to_fraction([(NSNumber *)_durations[i] doubleValue], &chunk_fcTL.delay_num, &chunk_fcTL.delay_den);
                chunk_fcTL.delay_num = chunk_fcTL.delay_num;
                chunk_fcTL.delay_den = chunk_fcTL.delay_den;
                chunk_fcTL.dispose_op = UAVS_YY_PNG_DISPOSE_OP_BACKGROUND;
                chunk_fcTL.blend_op = UAVS_YY_PNG_BLEND_OP_SOURCE;
                ...
                *((uint32_t *)(fcTL + 34)) = uavs_yy_swap_endian_uint32((uint32_t)crc32(0, (const Bytef *)(fcTL + 4), 30));
                ...
                for (int d = 0; d < frame->chunk_num; d++) {
                    uavs_yy_png_chunk_info *dchunk = frame->chunks + d;
                    if (dchunk->fourcc == YY_FOUR_CC('I', 'D', 'A', 'T')) {
                        uint32_t length = uavs_yy_swap_endian_uint32(dchunk->length + 4);
                        [result appendBytes:&length length:4]; //length
                        uint32_t fourcc = YY_FOUR_CC('f', 'd', 'A', 'T');
                        [result appendBytes:&fourcc length:4]; //fourcc
                        uint32_t sq = uavs_yy_swap_endian_uint32(apngSequenceIndex);
                        ...
                        uint32_t crc = uavs_yy_swap_endian_uint32((uint32_t)crc32(0, bytes, dchunk->length + 8));
                        [result appendBytes:&crc length:4]; //crc
                        
                        apngSequenceIndex++;
                    }
                }
                uavs_yy_png_info_release(frame);
            }
        }
...
- (NSData *)_encodeWebP {
    ...
    for (NSUInteger i = 0; i < _images.count; i++) {
        ...
        if (!image) return nil;
        CFDataRef frameData = UAVS_YYCGImageCreateEncodedWebPData(image, _lossless, _quality, 4, UAVS_YYImagePresetDefault);
        CFRelease(image);
        if (!frameData) return nil;
...
- (NSData *)encode {
    ...
    if (_type == UAVS_YYImageTypePNG) return [self _encodeAPNG];
    if (_type == UAVS_YYImageTypeWebP) return [self _encodeWebP];
    return nil;
}
...
+ (NSData *)encodeImage:(UIImage *)image type:(UAVS_YYImageType)type quality:(CGFloat)quality {
    UAVS_YYImageEncoder *encoder = [[UAVS_YYImageEncoder alloc] initWithType:type];
    encoder.quality = quality;
    [encoder addImage:image duration:0];
    return [encoder encode];
}

+ (NSData *)encodeImageWithDecoder:(UAVS_YYImageDecoder *)decoder type:(UAVS_YYImageType)type quality:(CGFloat)quality {
...
@implementation UIImage (UAVS_YYImageCoder)

- (instancetype)yy_imageByDecoded {
    if (self.yy_isDecodedForDisplay) return self;
    CGImageRef imageRef = self.CGImage;
    if (!imageRef) return self;
    CGImageRef newImageRef = UAVS_YYCGImageCreateDecodedCopy(imageRef, YES);
...
- (BOOL)yy_isDecodedForDisplay {
    if (self.images.count > 1 || [self isKindOfClass:[UAVS_YYSpriteSheetImage class]]) return YES;
...
- (NSData *)_yy_dataRepresentationForSystem:(BOOL)forSystem {
    NSData *data = nil;
    if ([self isKindOfClass:[UAVS_YYImage class]]) {
        UAVS_YYImage *image = (id)self;
        if (image.animatedImageData) {
            if (forSystem) { // system only support GIF and PNG
                if (image.animatedImageType == UAVS_YYImageTypeGIF ||
                    image.animatedImageType == UAVS_YYImageTypePNG) {
    ...
    if (!data) {
        ...
        if (imageRef) {
            ...
            if (self.imageOrientation != UIImageOrientationUp) {
                CGImageRef rotated = UAVS_YYCGImageCreateCopyWithOrientation(imageRef, self.imageOrientation, bitmapInfo | alphaInfo);
                if (rotated) {
                    CFRelease(imageRef);
                    imageRef = rotated;
                }
