...
/**
 Image file type.
 */
typedef NS_ENUM(NSUInteger, UAVS_YYImageType) {
    UAVS_YYImageTypeUnknown = 0, ///< unknown
    UAVS_YYImageTypeJPEG,        ///< jpeg, jpg
    UAVS_YYImageTypeJPEG2000,    ///< jp2
    UAVS_YYImageTypeTIFF,        ///< tiff, tif
    UAVS_YYImageTypeBMP,         ///< bmp
    UAVS_YYImageTypeICO,         ///< ico
    UAVS_YYImageTypeICNS,        ///< icns
    UAVS_YYImageTypeGIF,         ///< gif
    UAVS_YYImageTypePNG,         ///< png
    UAVS_YYImageTypeWebP,        ///< webp
    UAVS_YYImageTypeOther,       ///< other image format
};
 ...
 */
typedef NS_ENUM(NSUInteger, UAVS_YYImageBlendOperation) {
    
    /**
     All color components of the frame, including alpha, overwrite the current
     contents of the frame's canvas region.
     */
    UAVS_YYImageBlendNone = 0,
    
    /**
     The frame should be composited onto the output buffer based on its alpha.
     */
    UAVS_YYImageBlendOver,
};

/**
 An image frame object.
 */
@interface UAVS_YYImageFrame : NSObject <NSCopying>
...
@property (nonatomic) UAVS_YYImageDisposeMethod dispose;     ///< Frame dispose method.
@property (nonatomic) UAVS_YYImageBlendOperation blend;      ///< Frame blend operation.
 ...
 */
@interface UAVS_YYImageDecoder : NSObject

@property (nullable, nonatomic, readonly) NSData *data;    ///< Image data.
@property (nonatomic, readonly) UAVS_YYImageType type;          ///< Image data type.
 ...
 */
- (nullable UAVS_YYImageFrame *)frameAtIndex:(NSUInteger)index decodeForDisplay:(BOOL)decodeForDisplay;
 ...
 */
@interface UAVS_YYImageEncoder : NSObject

@property (nonatomic, readonly) UAVS_YYImageType type; ///< Image type.
 ...
 */
- (nullable instancetype)initWithType:(UAVS_YYImageType)type NS_DESIGNATED_INITIALIZER;
...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImage:(UIImage *)image type:(UAVS_YYImageType)type quality:(CGFloat)quality;
...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImageWithDecoder:(UAVS_YYImageDecoder *)decoder type:(UAVS_YYImageType)type quality:(CGFloat)quality;
...
@interface UIImage (UAVS_YYImageCoder)
...
CG_EXTERN UAVS_YYImageType UAVS_YYImageDetectType(CFDataRef data);

/// Convert YYImageType to UTI (such as kUTTypeJPEG).
CG_EXTERN CFStringRef _Nullable UAVS_YYImageTypeToUTType(UAVS_YYImageType type);

/// Convert UTI (such as kUTTypeJPEG) to YYImageType.
CG_EXTERN UAVS_YYImageType UAVS_YYImageTypeFromUTType(CFStringRef uti);

/// Get image type's file extension (such as @"jpg").
CG_EXTERN NSString *_Nullable UAVS_YYImageTypeGetExtension(UAVS_YYImageType type);



/// Returns the shared DeviceRGB color space.
CG_EXTERN CGColorSpaceRef UAVS_YYCGColorSpaceGetDeviceRGB(void);

/// Returns the shared DeviceGray color space.
CG_EXTERN CGColorSpaceRef UAVS_YYCGColorSpaceGetDeviceGray(void);

/// Returns whether a color space is DeviceRGB.
CG_EXTERN BOOL UAVS_YYCGColorSpaceIsDeviceRGB(CGColorSpaceRef space);

/// Returns whether a color space is DeviceGray.
CG_EXTERN BOOL UAVS_YYCGColorSpaceIsDeviceGray(CGColorSpaceRef space);



/// Convert EXIF orientation value to UIImageOrientation.
CG_EXTERN UIImageOrientation UAVS_YYUIImageOrientationFromEXIFValue(NSInteger value);

/// Convert UIImageOrientation to EXIF orientation value.
CG_EXTERN NSInteger UAVS_YYUIImageOrientationToEXIFValue(UIImageOrientation orientation);
 ...
 */
CG_EXTERN CGImageRef _Nullable UAVS_YYCGImageCreateDecodedCopy(CGImageRef imageRef, BOOL decodeForDisplay);
 ...
 */
CG_EXTERN CGImageRef _Nullable UAVS_YYCGImageCreateCopyWithOrientation(CGImageRef imageRef,
...
/**
 ...
 @return A new image, or NULL if an error occurs.
 */
CG_EXTERN CGImageRef _Nullable UAVS_YYCGImageCreateAffineTransformCopy(CGImageRef imageRef,
 ...
 */
CG_EXTERN CFDataRef _Nullable UAVS_YYCGImageCreateEncodedData(CGImageRef imageRef, UAVS_YYImageType type, CGFloat quality);


/**
 Whether WebP is available in YYImage.
 */
CG_EXTERN BOOL UAVS_YYImageWebPAvailable(void);
 ...
 */
CG_EXTERN NSUInteger UAVS_YYImageGetWebPFrameCount(CFDataRef webpData);
 ...
 */
CG_EXTERN CGImageRef _Nullable UAVS_YYCGImageCreateWithWebPData(CFDataRef webpData,
                                                           BOOL decodeForDisplay,
                                                           BOOL useThreads,
                                                           BOOL bypassFiltering,
                                                           BOOL noFancyUpsampling);

typedef NS_ENUM(NSUInteger, UAVS_YYImagePreset) {
    UAVS_YYImagePresetDefault = 0,  ///< default preset.
    UAVS_YYImagePresetPicture,      ///< digital picture, like portrait, inner shot
    UAVS_YYImagePresetPhoto,        ///< outdoor photograph, with natural lighting
    UAVS_YYImagePresetDrawing,      ///< hand or line drawing, with high-contrast details
    UAVS_YYImagePresetIcon,         ///< small-sized colorful images
    UAVS_YYImagePresetText          ///< text-like
};
 ...
 */
CG_EXTERN CFDataRef _Nullable UAVS_YYCGImageCreateEncodedWebPData(CGImageRef imageRef,
                                                             BOOL lossless,
                                                             CGFloat quality,
                                                             int compressLevel,
                                                             UAVS_YYImagePreset preset);
