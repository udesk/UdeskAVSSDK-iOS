...
typedef NS_ENUM(NSUInteger, UAVS_YYWebImageFromType) {
    ...
    UAVS_YYWebImageFromMemoryCacheFast,
    
    /// Fetched from memory cache.
    UAVS_YYWebImageFromMemoryCache,
    
    /// Fetched from disk cache.
    UAVS_YYWebImageFromDiskCache,
    
    /// Fetched from remote (web or file path).
    UAVS_YYWebImageFromRemote,
};

/// Indicated image fetch complete stage.
typedef NS_ENUM(NSInteger, UAVS_YYWebImageStage) {
    
    /// Incomplete, progressive image.
    UAVS_YYWebImageStageProgress  = -1,
    
    /// Cancelled.
    UAVS_YYWebImageStageCancelled = 0,
    
    /// Finished (succeed or failed).
    UAVS_YYWebImageStageFinished  = 1,
};
 ...
 */
typedef void(^UAVS_YYWebImageProgressBlock)(NSInteger receivedSize, NSInteger expectedSize);
 ...
 */
typedef UIImage * _Nullable (^UAVS_YYWebImageTransformBlock)(UIImage *image, NSURL *url);
 ...
 */
typedef void (^UAVS_YYWebImageCompletionBlock)(UIImage * _Nullable image,
                                                NSURL *url,
                                                UAVS_YYWebImageFromType from,
                                                UAVS_YYWebImageStage stage,
 ...
 */
@interface UAVS_YYWebImageManager : NSObject
 ...
 */
- (instancetype)initWithCache:(nullable UAVS_YYImageCache *)cache
 ...
 */
- (nullable UAVS_YYWebImageOperation *)requestImageWithURL:(NSURL *)url
 ...
 */
@property (nullable, nonatomic, strong) UAVS_YYImageCache *cache;
 ...
 */
@property (nullable, nonatomic, copy) UAVS_YYWebImageTransformBlock sharedTransformBlock;
