...
+ (UIImage *)imageWithOriginalImage:(UIImage *)image maxWidth:(CGFloat)maxWidth maxHeight:(CGFloat)maxHeight {
    ...
    image = [UdeskAVSImageUtil imageCompressWithImage:image targetHeight:targetH targetWidth:targetW];
...
+ (UIImage *)imageWithOriginalImage:(UIImage *)image {
    ...
    return [UdeskAVSImageUtil imageWithOriginalImage:image maxWidth:1280 maxHeight:1280];
}
...
+ (CGSize)richImageSize:(UIImage *)image {
    ...
    return [UdeskAVSImageUtil udeskImageSize:image fixedSize:fixedSize];
}
